...
import { EditDepartmentsComponent } from './departments/components/edit-departments/edit-departments.component';
import { EditPetsComponent } from './patients/components/edit-pets/edit-pets.component';
...
const routes: Routes = [
  ...
  {path:'editDepartment/:id', component:EditDepartmentsComponent},
  {path:'editPatient/:id', component:EditPetsComponent},
